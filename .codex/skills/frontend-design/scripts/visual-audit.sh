...
#
# USAGE:
#   bash .codex/skills/frontend-design/scripts/visual-audit.sh http://localhost:5173
#   bash .codex/skills/frontend-design/scripts/visual-audit.sh http://localhost:5173 /about /dashboard
#
# OUTPUT:
