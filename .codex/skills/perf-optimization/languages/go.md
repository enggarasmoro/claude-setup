...
.codex/skills/perf-optimization/scripts/go-pprof.sh cpu path/to/cpu.prof

# Heap profile from a live endpoint
.codex/skills/perf-optimization/scripts/go-pprof.sh heap http://localhost:6060/debug/pprof/heap

# CPU profile from a benchmark (generates and analyzes in one step)
.codex/skills/perf-optimization/scripts/go-pprof.sh bench ./internal/platform/server/... BenchmarkRequireAuth
```
